...
export const fetchInfoDiskSucces = (info) => {
  return {
    type: Types.FETCH_INFO_DISK_SUCCES,
    payload: info,
  };
};
...
export const fetchInfoDiskFailed = (e) => {
  return {
    type: Types.FETCH_INFO_DISK_FAILED,
    message: e.message,
  };
};
...
export const fetchResourcesSucces = (res) => {
  return {
    type: Types.FETCH_RESOURCES_SUCCES,
    payload: res,
  };
};
...
export const createFolderSucces = (pathname) => {
  return {
    type: Types.CREATE_FOLDER_SUCCES,
    payload: pathname,
  };
};
...
export const createFolderFailed = (e) => {
  return {
    type: Types.CREATE_FOLDER_FAILED,
    message: e.message,
  };
};
...
export const uploadFileSucces = () => {
  return {
    type: Types.UPLOAD_FILE_SUCCES,
    payload: 'Загрузка началась',
  };
};
